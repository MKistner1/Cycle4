...
public class YewCutter{
	final static RSArea treeLocation = new RSArea(new RSTile(3089,3483,0), new RSTile(3084,3468,0));
	...
	public static boolean cutTree() {
		RSObject[] trees = Objects.findNearest(10,"Yew");
