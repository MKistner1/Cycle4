...
public class OakCutter{
	final static RSArea treeLocation = new RSArea(new RSTile(3171,3423,0), new RSTile(3159,3408,0));
	...
	public static boolean cutTree() {
		RSObject[] trees = Objects.findNearest(10,"Oak");
